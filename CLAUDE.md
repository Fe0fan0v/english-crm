...
- **Жёсткая проверка**: при создании урока, если `student.balance < lesson_type.price` → HTTP 400 с перечислением учеников и их балансов. Урок НЕ создаётся
...
- Frontend отображает ошибку в красном блоке в `LessonCreateModal`
