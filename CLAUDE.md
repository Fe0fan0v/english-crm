...
- [x] Конструктор курсов (Course Constructor) — интерактивные учебные материалы с 17 типами блоков
...
- `LessonEditorPage` — редактор блоков урока (17 типов блоков)
...
- `BlockEditor` — редакторы для всех 17 типов блоков упражнений
...
83. **Конструктор курсов (Course Constructor)** — полноценная система создания интерактивных учебных материалов (аналог Edvibe):
    ...
    - 17 типов блоков: контентные (text, video, audio, image, article, divider, teaching_guide, remember, table) и интерактивные (fill_gaps, test, true_false, word_order, matching, image_choice, flashcards, essay)
