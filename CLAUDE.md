...
├── alembic/versions/  # Миграции (000-019)
└── requirements.txt
...
**Компоненты:**
- `BlockEditor.tsx` — редакторы для всех типов блоков
- `BlockRenderer.tsx` — рендереры для просмотра блоков
...
83. **Конструктор курсов (Course Constructor)** — полноценная система создания интерактивных учебных материалов (аналог Edvibe):
    ...
    - Ветка: `feature/course-constructor`
