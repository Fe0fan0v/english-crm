#!/usr/bin/env python3
"""
Скрипт для запуска в Docker контейнере на сервере.

Использование:
    1. Скопировать файлы на сервер:
       scp scripts/edvibe_parser/output/jsi_hierarchy_Beginner_20260203_211912.json jsi:~/data.json
       scp scripts/edvibe_parser/update_course_docker.py jsi:~/update_course.py
...
# Конфигурация
COURSE_ID = 10  # ID курса для обновления
